...
public class IslandArea {
    ...
    public IslandArea(final Location point1, final Location point2) {
    ...
    public int getTotalBlockSize(int height) {
        return height * this.getXWidth() * this.getZWidth();
    }
    ...
    public boolean isIn(World w, double x, double y, double z) {
        return w == this.world && x >= this.xMin && x <= this.xMax && y >= this.yMin && y <= this.yMax && z >= this.zMin && z <= this.zMax;
    }
